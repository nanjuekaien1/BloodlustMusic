...
if LOCALE == "zhCN" then
	...
	L["Favored Friend Name: "] = "好友姓名："
	L["Favored Friend Song Title: "] = "好友歌曲标题："
	L["Pending changes: \n \n \n|cFFFFD100'"] = "待处理更改：\n \n \n|cFFFFD100'"
	...
	L["Want to hear a certain song when a certain player casts Hero? You can by using the Favored Friend feature below. Just click the edit button and enter some values in the screen that pops up. You'll need the name of your friend, the title of the song, and the filename. The song can be either a song in the default list or a custom one, following the same rules for custom songs as above. More info on the addon page."] = "想在某个玩家施放英勇时听到特定的歌曲吗？你可以使用下面的好友功能。只需点击编辑按钮并在弹出的屏幕中输入一些值。你需要你朋友的姓名、歌曲的标题和文件名。歌曲可以是默认列表中的歌曲或自定义歌曲，遵循上述自定义歌曲的相同规则。有关更多信息，请访问插件页面。"
	L["\n \nPending changes: \n \n|cFFFFD100'"] = "\n \n待处理更改：\n \n|cFFFFD100'"
	L["\n \nThis will set this song back to its default, hard-coded values. \n \n|cFFFFD100'"] = "\n \n这将把这首歌恢复到其默认的硬编码值。\n \n|cFFFFD100'"
	...
	L["Ambience"] = "环境音"
	L["Dialog"] = "对话"
	L["Hero was cast by your Favored Friend: "] = "英勇由你的好友施放："
	L["Master"] = "主音道"
	L["Music"] = "音乐"
